...
## Data Preparation
I followed the Medium article on Gutenberg use case for data collection. If you want to use another dataset, you can just put it and write a custom code to download it, nothing too hard. My long-term goal is to use low-resource languages instead of English here to work with.
